...
* Each time block covers an hour and has a text area where the user can input an event that they to complete in that time block.
...
* This means that when the user revisits the webpage or refreshes, the event that they have inputted will always be there to be viewed until they decide to delete it. 
